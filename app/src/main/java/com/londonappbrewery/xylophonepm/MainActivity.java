...
public class MainActivity extends AppCompatActivity {
    ...
    // Member variables
    private SoundPool mSoundPool;  // empty member variable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHCSoundId = mSoundPool.load(getApplicationContext(), R.raw.note8_c, 1);
    }
    ...
    public void playA(View v) {
        Log.d("Xylophone", "Dark Blue Button Clicked");
    ...
    public void playHC(View v) {
        Log.d("Xylophone", "Purple Button Clicked");
        mSoundPool.play(mHCSoundId, LEFT_VOLUME, RIGHT_VOLUME, PRIORITY, NO_LOOP, NORMAL_PLAY_RATE);
    }
